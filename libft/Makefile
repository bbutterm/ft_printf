...
SRC=ft_memset.c ft_bzero.c ft_memcpy.c ft_memcpy.c ft_memccpy.c \
ft_memmove.c ft_memchr.c ft_memcmp.c ft_memdel.c \
...
ft_toupper.c ft_tolower.c ft_memalloc.c ft_strtrim.c \
...
ft_ffree.c ft_strrev.c ft_lstlen.c ft_swap.c ft_strlchr.c \
